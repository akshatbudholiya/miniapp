    ...
    <div className="login-page">
      <nav className="terms-nav">
        ...
        <div className="nav-right-container">
          ...
          <button className="lang-select" onClick={toggleLanguage}>
      ...
      <aside className={`mobile-menu ${menuOpen ? "show" : ""}`}>
        ...
        >
          <img src={mobileSwitchFlag} alt="flag" />
      ...
      <div className="login-box">
        ...
        <div className="login-footer-links">
          <p onClick={() => navigate("/register")}>{texts.register || "Register"}</p>
          <p onClick={() => navigate("/forgot-password")}>{texts.forgot_password || "Forgotten password?"}</p>
        </div>
      </div>
    </div>
  );
